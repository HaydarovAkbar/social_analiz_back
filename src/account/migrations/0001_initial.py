    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, error_messages={'unique': 'Userth this phone number already exists.'}, help_text='Required. Only international format used. (998901234567)', max_length=128, null=True, region=None, unique=True, verbose_name='Phone number')),
